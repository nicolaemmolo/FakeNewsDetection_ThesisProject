...
RESULTS_DIR_PATH = f"results/results_CNN_{TASK_TYPE}"
bool_150 = False
...
def objectiveCNN(trial, X_train, y_train, X_val, y_val, embedding_matrix, num_words, embedding_dim=300):
    """
...
study.optimize(objective_with_data, n_trials=1) # 50 trials for demonstration; increase for better results
