...
X_train = np.concatenate([datasets[task]['train'][0] for task in datasets], axis=0)
y_train = np.concatenate([datasets[task]['train'][1] for task in datasets], axis=0)
X_val = np.concatenate([datasets[task]['val'][0] for task in datasets], axis=0)
y_val = np.concatenate([datasets[task]['val'][1] for task in datasets], axis=0)
