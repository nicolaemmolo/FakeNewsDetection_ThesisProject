...
RESULTS_DIR_PATH = f"results/results_BERT_{TASK_TYPE}"
bool_150 = False
...
def objectiveBERT(trial, X_train, y_train, X_val, y_val):
    """
    Optuna objective function for hyperparameter optimization of BERT model.
...
objective_with_data = partial(objectiveBERT,
                               X_train=X_train,
                               y_train=y_train,
                               X_val=X_val,
                               y_val=y_val)
