...
*Note: Due to its significant file size, the model is not included in the repository. You can download it on [https://code.google.com/archive/p/word2vec/](https://code.google.com/archive/p/word2vec/).*
